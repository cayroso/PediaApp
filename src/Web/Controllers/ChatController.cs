...
namespace Web.Controllers
{
    ...
    public class ChatController : BaseController
    {
        ...
        [HttpGet("unread")]
        public async Task<IActionResult> SearchUnreadChat([FromServices] ChatService chatService, string criteria, int pageIndex = 1, int pageSize = 10, CancellationToken cancellationToken = default)
        {
