<template>
    <div v-cloak>
        ...
        <div class="row align-items-center">
            <div class="col-sm">
                <h1 class="h3 mb-sm-0">
                    <i class="fas fa-fw fa-clinic-medical mr-1"></i>Clinics
                </h1>
            </div>
        ...
        <b-overlay :show="busy">
            <div class="mt-2 table-responsive shadow-sm">
                <table-list :header="{key: 'clinicId', columns:[]}" :items="filter.items" :getRowNumber="getRowNumber" :setSelected="setSelected" :isSelected="isSelected" table-css="">
                    <template #header>
                    ...
                    <template slot="table" slot-scope="row">
                        ...
                        <td>
                            <router-link :to="{name:'clinicsView', params:{id: row.item.clinicId}}">
                                {{row.item.name}}
                            </router-link>
                        </td>
                        <!--<td>
